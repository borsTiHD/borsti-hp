<template>
	<div class="flex flex-col text-gray-900 dark:text-white">
		<div class="flex justify-center">
			<div class="my-4">
				<h1 class="text-gray-900 dark:text-white text-5xl font-bold self-center">Impressum</h1>
				<p class="text-primary-light dark:text-primary text">Angaben gemäß § 5 TMG</p>
			</div>
		</div>
		<section class="flex justify-center bg-white dark:bg-body-bg p-8">
			<div class="container mx-auto">
				<AppCard class="impressum">
					<template #header>Impressum</template>
					<p class="mb-4">Angaben gemäß § 5 TMG</p>
					<p>Bastian Jakobs</p>
					<p>Eschmarer Str. 26</p>
					<p>53844 Troisdorf</p>
					...
					<p class="mt-4"><strong>Haftung für Links</strong></p>
					...
					<p class="mt-4"><strong>Urheberrecht</strong></p>
					...
					<p class="mt-4"><strong>Datenschutz</strong></p>
